...
class SwapBase {
    ...
    queryConstants() {
        ...
        return {
            tradingPathLimit: parseInt(((_d = (_c = (_b = (_a = this.api) === null || _a === void 0 ? void 0 : _a.consts) === null || _b === void 0 ? void 0 : _b.dex) === null || _c === void 0 ? void 0 : _c.tradingPathLimit) === null || _d === void 0 ? void 0 : _d.toString()) || '3'),
            fee: {
    ...
    getBestSwapResult(mode, paths, liquidityPools, baseParams) {
        ...
        const result = swapResult.reduce((preResult, [error, result], i) => {
            ...
            return result;
        }, (_a = swapResult === null || swapResult === void 0 ? void 0 : swapResult[0]) === null || _a === void 0 ? void 0 : _a[1]);
