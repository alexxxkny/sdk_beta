...
describe('fixed point number constructor should worker', () => {
    test('toString & toNumber', () => {
        const a = fixed_point_number_1.FixedPointNumber.fromInner('123456789123456789123456789');
        expect(a.toString(8)).toEqual('123456789.12345678');
    ...
    test('construct from number', () => {
        const a = new fixed_point_number_1.FixedPointNumber(1);
        const b = new fixed_point_number_1.FixedPointNumber(1, 2);
        const c = fixed_point_number_1.FixedPointNumber.fromInner(1e18, 18);
        const d = new fixed_point_number_1.FixedPointNumber(1.23456, 18);
        ...
        expect(fixed_point_number_1.FixedPointNumber.fromInner(c._getInner().toNumber() + 1).toNumber(18)).toEqual(1 + 1e-18);
        expect(d.toString(18, 2)).toEqual('1.23456');
    });
    test('construct from inner', () => {
        const a = fixed_point_number_1.FixedPointNumber.fromInner(1000000, 6);
        expect(a.toNumber()).toEqual(1);
    });
    test('no scientific natation', () => {
        const a = new fixed_point_number_1.FixedPointNumber(1, 99);
        const b = new fixed_point_number_1.FixedPointNumber(1e-99, 1);
    ...
    test('setPrecision', () => {
        const a = new fixed_point_number_1.FixedPointNumber(1000000, 6);
        const b = new fixed_point_number_1.FixedPointNumber(1000000, 6);
        b.setPrecision(12);
...
describe('fixed point number calculation should worker', () => {
    test('get the absolute value', () => {
        const a = new fixed_point_number_1.FixedPointNumber(-1);
        const b = new fixed_point_number_1.FixedPointNumber(1);
        expect(a.abs().toNumber()).toEqual(1);
        expect(b.abs().toNumber()).toEqual(1);
    });
    test('plus', () => {
        const a = new fixed_point_number_1.FixedPointNumber(100);
        const b = new fixed_point_number_1.FixedPointNumber(100);
        const c = new fixed_point_number_1.FixedPointNumber(100, 18);
        const d = new fixed_point_number_1.FixedPointNumber(100, 16);
        const e = fixed_point_number_1.FixedPointNumber.fromInner(100, 2);
        const f = fixed_point_number_1.FixedPointNumber.fromInner(100, 4);
        expect(a.plus(b).toNumber()).toEqual(200);
        expect(c.plus(d).toNumber()).toEqual(200);
        expect(e.plus(f).toNumber()).toEqual(1.01);
    });
    test('minus', () => {
        const a = new fixed_point_number_1.FixedPointNumber(200);
        const b = new fixed_point_number_1.FixedPointNumber(100);
        const c = new fixed_point_number_1.FixedPointNumber(200, 18);
        const d = new fixed_point_number_1.FixedPointNumber(100, 16);
        const e = fixed_point_number_1.FixedPointNumber.fromInner(100, 2);
        const f = fixed_point_number_1.FixedPointNumber.fromInner(100, 4);
    ...
    test('div', () => {
        ...
        const e = fixed_point_number_1.FixedPointNumber.fromInner(100, 2);
        const f = fixed_point_number_1.FixedPointNumber.fromInner(100, 4);
        const n = new fixed_point_number_1.FixedPointNumber(100, 2);
        const m = new fixed_point_number_1.FixedPointNumber(3, 2);
...
describe('fixed point number compare should worker', () => {
    test('isZero', () => {
        const a = new fixed_point_number_1.FixedPointNumber(0);
        const b = new fixed_point_number_1.FixedPointNumber(1);
        expect(a.isZero()).toEqual(true);
        expect(b.isZero()).toEqual(false);
    });
    test('isNaN', () => {
        const a = new fixed_point_number_1.FixedPointNumber(NaN);
        const b = new fixed_point_number_1.FixedPointNumber(0);
        const c = new fixed_point_number_1.FixedPointNumber(0);
        const d = new fixed_point_number_1.FixedPointNumber(1);
    ...
    test('isNegative', () => {
        const a = new fixed_point_number_1.FixedPointNumber(NaN);
        const b = new fixed_point_number_1.FixedPointNumber(1);
        const c = new fixed_point_number_1.FixedPointNumber(-1);
    ...
    test('isGreaterThan', () => {
        const a = new fixed_point_number_1.FixedPointNumber(2);
        const b = new fixed_point_number_1.FixedPointNumber(1);
        const c = new fixed_point_number_1.FixedPointNumber(-1);
    ...
    test('isGreaterOrEqualThan', () => {
        const a = new fixed_point_number_1.FixedPointNumber(2);
        const b = new fixed_point_number_1.FixedPointNumber(1);
        const c = new fixed_point_number_1.FixedPointNumber(2);
    ...
    test('isLessThan', () => {
        const a = new fixed_point_number_1.FixedPointNumber(2);
        const b = new fixed_point_number_1.FixedPointNumber(10);
    ...
    test('isEqualTo', () => {
        const a = new fixed_point_number_1.FixedPointNumber(2, 2);
        const b = new fixed_point_number_1.FixedPointNumber(2, 3);
        expect(a.isEqualTo(b)).toEqual(true);
    ...
    test('min max', () => {
        const a = new fixed_point_number_1.FixedPointNumber(2, 2);
        const b = new fixed_point_number_1.FixedPointNumber(2, 3);
        const c = new fixed_point_number_1.FixedPointNumber(2, 18);
        const d = new fixed_point_number_1.FixedPointNumber(4, 3);
    ...
    test('trunc frac', () => {
        const a = fixed_point_number_1.FixedPointNumber.fromRational(5, 2);
        const a1 = a.trunc();
        const a2 = a.frac();
        expect(a1.plus(a2).toString()).toEqual(a.toString());
        const b = fixed_point_number_1.FixedPointNumber.fromRational(5, 2).frac().times(fixed_point_number_1.FixedPointNumber.TEN);
        expect(b.toString()).toEqual(fixed_point_number_1.FixedPointNumber.FIVE.toString());
        const c = fixed_point_number_1.FixedPointNumber.fromRational(-5, 2);
        const c1 = c.trunc();
        const c2 = c.frac();
        expect(c1.minus(c2).toString()).toEqual(c.toString());
        expect(c2.times(fixed_point_number_1.FixedPointNumber.TEN).toString()).toEqual(fixed_point_number_1.FixedPointNumber.FIVE.toString());
        const d = fixed_point_number_1.FixedPointNumber.fromRational(-1, 2).frac().times(fixed_point_number_1.FixedPointNumber.TEN);
        expect(d.toString()).toEqual(fixed_point_number_1.FixedPointNumber.ZERO.minus(fixed_point_number_1.FixedPointNumber.FIVE).toString());
    });
});
