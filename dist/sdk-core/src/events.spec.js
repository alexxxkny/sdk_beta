...
describe('event', () => {
    test('filter events should work', () => {
        ...
        const result1 = (0, events_1.eventsFilter)(eventsFilterConfig)({
            event: { section: 'section1', method: 'method1' }
        });
        const result2 = (0, events_1.eventsFilter)(eventsFilterConfig)({
            event: { section: 'section2', method: 'method2' }
        });
        const result3 = (0, events_1.eventsFilter)(eventsFilterConfig)({
            event: { section: 'section3', method: 'method3' }
        });
        const result4 = (0, events_1.eventsFilter)(eventsFilterConfig)({
    ...
    test('filter events wildcard should work', () => {
        ...
        const result1 = (0, events_1.eventsFilter)(eventsFilterConfig1)({
            event: { section: 'section3', method: 'method1' }
        });
        const result2 = (0, events_1.eventsFilter)(eventsFilterConfig1)({
            event: { section: 'section2', method: 'method2' }
        });
        const result3 = (0, events_1.eventsFilter)(eventsFilterConfig2)({
            event: { section: 'section1', method: 'a' }
        });
        const result4 = (0, events_1.eventsFilter)(eventsFilterConfig2)({
            event: { section: 'section1', method: 'b' }
        });
        const result5 = (0, events_1.eventsFilter)(eventsFilterConfig2)({
